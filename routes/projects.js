...
router.post("/", authMiddleware, async (req, res) => {
  ...
  await Project.create({ title, details, subscript, role, start, end, email, phone, id, nickname, createdAt }).then((result) => {
...
router.put("/:projectId", authMiddleware, async (req, res) => {
  ...
  try {
    Project.update({ title, details, subscript, role, start, end, email, phone, nickname }, { where: { projectId: projectId } });
